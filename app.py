...
if __name__ == "__main__":
    ...
    description = "<h3>😎6.4更新：新增自定义底色</h3>"
    css = '''
    h1#title, h3 {
      text-align: center;
    }
    ...
    with demo:
        ...
        img_but.click(idphoto_inference, inputs=[img_input, size_options, color_options, custom_color_R, custom_color_G, custom_color_B],
